...
public class TaskDialogScreen extends javax.swing.JDialog {
    ...
    public TaskDialogScreen(java.awt.Frame parent, boolean modal) throws Exception {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelToolBarSave.setIcon(new ImageIcon(TaskDialogScreen.class.getResource("/view/check.png")));
        jLabelToolBarSave.setBackground(new Color(255, 128, 192));
       ...
       // jLabelToolBarSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("C:/check.png"))); // NOI18N*/
...
//                project.setId((String) .getInt("id"));
                project.setName((String)jTextFieldName.getString("name"));
                project.setDescription((String)jTextAreaDescription.getString("description"));
                project.setCreatedAt((String)jTextAreaNotes.getString("createdAt"));
                project.setUpdatedAt((date)jFormattedTextFieldDeadLine.getString("update"));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TaskDialogScreen dialog = null;
				try {
					dialog = new TaskDialogScreen(new javax.swing.JFrame(), true);
				} catch (Exception e1) {
