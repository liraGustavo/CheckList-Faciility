...
public class MainScreen extends javax.swing.JFrame {
	...
	protected static final JComponent dialog = null;
    ...
    private void initComponents() {
        ...
        jLabelTasksToolBarAdd.setIcon(new ImageIcon(MainScreen.class.getResource("/view/add.png")));
        ...
        jLabelToolBarTitle.setText("Checklist Facility");
        ...
        jPanelToolBarLayout.setHorizontalGroup(
        	jPanelToolBarLayout.createParallelGroup(Alignment.LEADING)
        		.addGroup(jPanelToolBarLayout.createSequentialGroup()
        			.addContainerGap()
        			.addGroup(jPanelToolBarLayout.createParallelGroup(Alignment.LEADING)
        				.addComponent(jLabelToolBarSubTitle, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 934, Short.MAX_VALUE)
        				.addComponent(jLabelToolBarTitle, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 934, Short.MAX_VALUE))
        			.addContainerGap())
        );
        jPanelToolBarLayout.setVerticalGroup(
        	jPanelToolBarLayout.createParallelGroup(Alignment.LEADING)
        		.addGroup(Alignment.TRAILING, jPanelToolBarLayout.createSequentialGroup()
        ...
        jLabelProjectsToolBarAdd.setIcon(new ImageIcon(MainScreen.class.getResource("/view/add.png"))); // NOI18N
        ...
        jLabelEmptyTasksImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("list.png"))); // NOI18N
    ...
    private void jLabelTasksToolBarAddMouseClicked(java.awt.event.MouseEvent evt) throws Exception {//GEN-FIRST:event_jLabelTasksToolBarAddMouseClicked
        ...
        if (indexSeletecProject != -1) {
            ...
            Project project = (Project) extracted().get(jListProjects.getSelectedIndex());
            ...
            taskDialogScreen.addWindowListener(new WindowAdapter() {
                public void windowClosed(WindowEvent e) {
                    ...
                    Project project = (Project) extracted().get(projectIndex);
    ...
    private void jLabelProjectsToolBarAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelProjectsToolBarAddMouseClicked
        ...
        ProjectDialogScreen<Object> projectDialogScreen = new ProjectDialogScreen<Object>(this, true);
    ...
    private void jTableTasksMouseClicked(java.awt.event.MouseEvent evt) throws SQLException {//GEN-FIRST:event_jTableTasksMouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                dialog.setVisible((Boolean) null);
            }
        });
    }
    ...
    private void initDataAccessObjects() throws Exception {
    ...
    private void loadProjects() {
        ...
        jListProjects.setModel(extracted());
    }

	private DefaultListModel extracted() {
    ...
    /*private void initComponentsModel() {
        setProjectsModel(new DefaultListModel<Object>());
        loadProjects();
	...
	@SuppressWarnings("rawtypes")
	public DefaultListModel getProjectsModel() {
		return projectsModel;
	}

	public void setProjectsModel(DefaultListModel<?> projectsModel) {
